              ...
              <div className=''>
                  ...
                  <h1 className='text-center text-lg text-primary mb-5 '>Ei Khaing Soe</h1>
                    <div className="inline-flex rounded-md mb-5 shadow-sm" role="group">
                        ...
                        <button type="button" className="inline-flex rounded-r-lg items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-primary hover:text-white  dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
...
{/*                             
                                    ...
                                    <div className="flex items-center hover:text-primary justify-between space-x-4">
                                      <div>Email</div>
                                      <div className=' text-bold text-base'>eikhaingsoe@gmail.com</div>
